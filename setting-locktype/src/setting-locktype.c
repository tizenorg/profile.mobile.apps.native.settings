...
void setting_locktype_ug_popup_resp_cb(void *data, Evas_Object *obj, void *event_info)
{
	SETTING_TRACE_BEGIN;
                                          ...
                                          Evas_Object *obj, void *event_info)
{
	...
	SettingLocktypeUG *ad = (SettingLocktypeUG *) data;	/* ad is point to data */
                                           ...
                                           void *priv)
{
	...
	setting_create_Gendial_itc("multiline/1text", &(locktypeUG->itc_bg_1icon));
	setting_create_Gendial_itc("dialogue/2text.3", &(locktypeUG->itc_2text_2));
	setting_create_Gendial_itc("dialogue/1text.1icon", &(locktypeUG->itc_1text_1icon));
	setting_create_Gendial_itc("dialogue/title", &(locktypeUG->itc_group_item));
	setting_create_Gendial_itc("dialogue/2text.3/expandable", &(locktypeUG->itc_2text_3_parent));


	locktypeUG->input_pwd = NULL;
	locktypeUG->notify = NULL;

	app_control_get_extra_data(service, "current", &(locktypeUG->input_pwd));
                                           ...
                                           void *priv)
{
	...
	evas_object_event_callback_del(locktypeUG->win_main_layout, EVAS_CALLBACK_RESIZE, setting_locktype_ug_cb_resize);	/* fix flash issue for gallery */
...
gboolean setting_locktype_create_password_sg(void *data)
{
	...
	safeCopyStr(str, locktype_table[ad->pw_type].pw_type_string, Max_Passwd_View_Type_Len);
