...
#define DEVOPTION_STR_ACCESSIBILITY_SCREEN_READER_SETTINGS_SOUND_FEEDBACK "Sound feedback"

/*english only translation */
#define DEVOPTION_STR_ACCESSIBILITY_SCREEN_READER_DESCRIPTION \
	"While Screen reader is enabled, your phone will provide voice feedback."\
	" For example, Screen reader will tell you what you can interact with on "\
	"each screen. Tap items to select them and hear what they are, and double "\
	"tap items to perform related action."
