...
void setting_time_update_time_date_format_string(SettingTimeData *ad)
{
	SETTING_TRACE_BEGIN;
		...
		Evas_Object *parent)
{
	...
	Eina_Bool
	ret = elm_layout_file_set(layout, SETTING_TIME_EDJEDIR"/setting-theme.edj",
			"date_time_layout");
		...
		void *event_info)
{
	...
	add_app_reply(&ad->md, "result", "lbutton_click");
	ui_app_exit();
}
