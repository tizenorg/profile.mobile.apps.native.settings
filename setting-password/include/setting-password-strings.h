...
#define PASSWORD_EXPIRED_CHANGE_PASSWORD	"Current password is expired. Change password."
...
#define PW_ST_PW_MIN_LENGTH_ALPHABETIC_HELP			"IDS_ST_BODY_PASSWORD_MUST_CONTAIN_AT_LEAST_PD_CHARACTERS_ABB"
