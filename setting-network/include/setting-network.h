...
#define Keystr_NetBrand_Auto "IDS_CST_OPT_GSM_WCDMA_HAUTO_CONNECT"/*"GSM/WCDMA (auto connect)" */
#define Keystr_NetBrand_Auto_WCDMA_GSM "IDS_CST_OPT_GSM_WCDMA_HAUTO_CONNECT"/*"GSM/WCDMA (auto connect)" */
...
#define keyStr_Failed_Select_Network "IDS_COM_BODY_YOUR_SIM_CARD_DOES_NOT_ALLOW_A_CONNECTION_TO_THIS_NETWORK"
