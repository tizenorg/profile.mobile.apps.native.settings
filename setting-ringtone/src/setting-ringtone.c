...
//ringtoneUG->md.view_layout = (Evas_Object *)ug_get_parent_layout(ug);
//ringtoneUG->md.win_main = (Evas_Object *)ug_get_window();
//evas_object_show(ringtoneUG->md.view_layout);
//ringtoneUG->md.evas = evas_object_evas_get(ringtoneUG->md.view_layout);
