		...
		const char *part)
{
	...
	Setting_GenGroupItem_Data *item_data =
			(Setting_GenGroupItem_Data *)data;
	/*SettingRingtoneData *ad = (SettingRingtoneData *) (item_data->userdata);*/
...
static inline void appmgrUg_init_itcs(SettingRingtoneData *ad)
{
	SETTING_TRACE_BEGIN;
...
char *get_default_filepath(SettingRingtoneData *ad)
{
