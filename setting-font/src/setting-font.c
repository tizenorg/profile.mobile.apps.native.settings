...
setting_view *__default_view_state(void *data, app_control_h service)
{
	...
	SettingFontData *fontUG = (SettingFontData *) data;
...
static bool _setting_font_app_create(void *priv)
{
	...
	elm_theme_extension_add(NULL, SETTING_FONT_EDJEDIR"/font-slider.edj");
	elm_theme_extension_add(NULL, SETTING_FONT_EDJEDIR"/setting-genlist.edj");
	elm_theme_extension_add(NULL, SETTING_FONT_EDJEDIR"/setting-theme.edj");
	...
	/* view type checking */
/*TODO: select proper view to load*/
	fontUG->view_to_load = __get_font_view_to_load(fontUG, /*service*/NULL);
