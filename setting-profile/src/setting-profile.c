...
static bool _setting_sound_app_create(void *priv)
{
	...
	elm_theme_extension_add(NULL, SETTING_PROFILE_EDJEDIR"/settings.edj");
	elm_theme_extension_add(NULL, SETTING_PROFILE_EDJEDIR"/setting-genlist.edj");
	elm_theme_extension_add(NULL, SETTING_PROFILE_EDJEDIR"/setting-theme.edj");
