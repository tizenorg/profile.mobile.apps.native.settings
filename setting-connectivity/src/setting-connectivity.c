...
static setting_view *__get_connective_view_to_load(app_control_h service)
{
	SETTING_TRACE_BEGIN;
	char *viewtype = NULL;
...
static bool __get_connective_layout(SettingConnectivity *ad,
