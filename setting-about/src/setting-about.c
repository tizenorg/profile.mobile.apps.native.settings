...
static Setting_Cfg_Node_T s_cfg_node_array[] = {
	{
			"IDS_ST_BODY_IMEI",
			NULL,
			"viewtype:frontpage;tab:first;keyword:IDS_ST_BODY_IMEI",
			0,
			0,
			0,
			Cfg_Item_View_Node,
			...
			NULL },
	{
			"IDS_ST_BODY_MY_NUMBER",
			NULL,
			"viewtype:frontpage;tab:first;keyword:IDS_ST_BODY_MY_NUMBER",
			0,
			0,
			0,
			Cfg_Item_View_Node,
			...
			NULL },
	{
			"IDS_CAM_POP_MODEL",
			NULL,
			"viewtype:frontpage;tab:first;keyword:IDS_CAM_POP_MODEL",
			0,
			0,
			0,
			Cfg_Item_View_Node,
			...
			NULL },
	{
			"IDS_ST_BODY_VERSION",
			NULL,
			"viewtype:frontpage;tab:first;keyword:IDS_ST_BODY_VERSION",
			0,
			0,
			0,
			Cfg_Item_View_Node,
			...
			NULL },
	{
			...
			NULL,
			"viewtype:frontpage;tab:first;keyword:IDS_ST_BODY_BLUETOOTH",
			0,
			0,
			0,
			Cfg_Item_View_Node,
			...
			NULL },
	{
			"IDS_ST_HEADER_WI_FI",
			NULL,
			"viewtype:frontpage;tab:first;keyword:IDS_ST_HEADER_WI_FI",
			0,
			0,
			0,
			Cfg_Item_View_Node,
			...
			NULL },
	{
			"IDS_ST_BODY_SERIAL_NUMBER",
			NULL,
			"viewtype:frontpage;tab:first;keyword:IDS_ST_BODY_SERIAL_NUMBER",
			0,
			0,
			0,
			Cfg_Item_View_Node,
			...
			NULL },
	{
			"IDS_ST_BODY_BATTERY",
			NULL,
			"viewtype:frontpage;tab:first;keyword:IDS_ST_BODY_BATTERY",
			0,
			0,
			0,
			Cfg_Item_View_Node,
			...
			NULL },
	{
			"IDS_ST_BODY_CPU_USAGE",
			NULL,
			"viewtype:frontpage;tab:first;keyword:IDS_ST_BODY_CPU_USAGE",
			0,
			0,
			0,
			Cfg_Item_View_Node,
			...
			NULL },
	{
			"IDS_ST_MBODY_DEVICE_STATUS",
			NULL,
			"viewtype:frontpage;tab:first;keyword:IDS_ST_MBODY_DEVICE_STATUS",
			0,
			0,
			0,
			Cfg_Item_View_Node,
			...
			NULL },
	{
			"IDS_ST_BODY_LICENCE",
			NULL,
			"viewtype:frontpage;tab:first;keyword:IDS_ST_BODY_LICENCE",
			0,
			0,
			0,
			Cfg_Item_View_Node,
			...
			NULL },
	{
			...
			NULL,
			"viewtype:frontpage;tab:first;keyword:IDS_ST_MBODY_SOFTWARE_UPDATE",
			0,
			0,
			0,
			Cfg_Item_View_Node,
			...
			NULL },
	{
			...
			NULL,
			"viewtype:frontpage;tab:first;keyword:IDS_ST_BODY_ADVANCEDOPTIONS_CERTIFICATES",
			0,
			0,
			0,
			Cfg_Item_View_Node,
...
{
	SETTING_TRACE_BEGIN;
	SETTING_TRACE("RRRRRR -3");
	SettingAboutUG *ad = (SettingAboutUG *) data;
	SETTING_TRACE("RRRRRR -2");
	setting_retvm_if((!ad), NULL, "!priv");
	SETTING_TRACE("RRRRRR -1");
	setting_set_i18n(SETTING_PACKAGE, ABOUT_LOCALEDIR);
	SETTING_TRACE("RRRRRR 0");
