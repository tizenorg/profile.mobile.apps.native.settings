...
static seting_about_menu_node main_menu[] = {
	...
	{"IDS_ST_MBODY_SOFTWARE_UPDATE", {'\0',}, UI_ID_SOFTWARE_UPDATE, NULL, NULL, &(view_data.itc_1text)},
	[UI_ID_MANAGE_CERTIFICATES] =
	{"IDS_ST_HEADER_MANAGE_CERTIFICATES_ABB", {'\0',}, UI_ID_MANAGE_CERTIFICATES, NULL, NULL, &(view_data.itc_1text)},
	[UI_ID_LICENCE] =
	{"IDS_ST_MBODY_LEGAL_INFORMATION_ABB", {'\0',}, UI_ID_LICENCE, NULL, NULL, &(view_data.itc_1text)},
	[UI_ID_DEVICE_INFO] =
	{"IDS_ST_BODY_DEVICE_INFORMATION", {'\0',}, UI_ID_DEVICE_INFO, NULL, NULL, &(view_data.itc_group_item)},
	[UI_ID_NAME] =
	{"IDS_ST_BODY_NAME", {'\0',}, UI_ID_NAME, NULL, &_device_name_change_cb, &(view_data.itc_2text_2)},
	[UI_ID_MY_NUMBER] =
	{"IDS_ST_BODY_MY_NUMBER", {'\0',}, UI_ID_MY_NUMBER, NULL, NULL, &(view_data.itc_2text_2)},
	[UI_ID_MODEL] =
	{"IDS_CAM_POP_MODEL", {'\0',}, UI_ID_MODEL, NULL, NULL, &(view_data.itc_2text_2)},
	[UI_ID_VERSION] =
	{"IDS_ST_BODY_VERSION", {'\0',}, UI_ID_VERSION, NULL, NULL, &(view_data.itc_2text_2)},
	[UI_ID_IMEI] =
	{"IDS_ST_BODY_IMEI", {'\0',}, UI_ID_IMEI, NULL, NULL, &(view_data.itc_2text_2)},
	[UI_ID_BLUETOOTH] =
	{"IDS_ST_BODY_BLUETOOTH", {'\0',}, UI_ID_BLUETOOTH, NULL, NULL, &(view_data.itc_2text_2)},
	[UI_ID_WI_FI] =
	{"IDS_ST_HEADER_WI_FI", {'\0',}, UI_ID_WI_FI, NULL, NULL, &(view_data.itc_2text_2)},
	[UI_ID_SERIAL_NUMBER] =
	{"IDS_ST_BODY_SERIAL_NUMBER", {'\0',}, UI_ID_SERIAL_NUMBER, NULL, NULL, &(view_data.itc_2text_2)},
	[UI_ID_BATTERY] =
	{"IDS_ST_BODY_BATTERY", {'\0',}, UI_ID_BATTERY, NULL, NULL, &(view_data.itc_2text_2)},
	[UI_ID_CPU_USAGE] =
	{"IDS_ST_BODY_CPU_USAGE", {'\0',}, UI_ID_CPU_USAGE, NULL, NULL, &(view_data.itc_2text_2)},
	[UI_ID_DEVICE_STATUS] =
	{"IDS_ST_MBODY_DEVICE_STATUS", {'\0',}, UI_ID_DEVICE_STATUS, NULL, NULL, &(view_data.itc_2text_2)},
	[UI_ID_SECURITY_STATUS] =
	{"IDS_ST_TMBODY_SECURITY_STATUS", {'\0',}, UI_ID_SECURITY_STATUS, NULL, NULL, &(view_data.itc_2text_2)}
};
...
bool setting_about_ui_init(void)
{
	...
	__create_itc(SETTING_GENLIST_ICON_1LINE_STYLE, &(view_data.itc_1text));
	__create_itc(SETTING_GENLIST_2LINE_STYLE, &(view_data.itc_2text_2));
	__create_itc(SETTING_GENLIST_2LINE_STYLE, &(view_data.itc_2text_3_parent));
	__create_itc(SETTING_GENLIST_2LINE_STYLE, &(view_data.itc_1icon_1text_sub));
	__create_itc(SETTING_GENLIST_GROUP_INDEX_STYLE, &(view_data.itc_group_item));
	__create_itc("multiline/1text", &(view_data.itc_help_style));
	__create_main_menu();
