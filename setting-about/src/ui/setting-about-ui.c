...
static seting_about_menu_node main_menu[] = {
	...
	[UI_ID_LICENCE] =
	{"IDS_ST_BODY_LICENCE", {'\0',}, UI_ID_LICENCE, NULL, NULL, &(view_data.itc_1text)},
	[UI_ID_NAME] =
...
bool setting_about_ui_init(void)
{
	...
	view_data.main_list = elm_genlist_add(navi);
	...
	elm_naviframe_item_push(navi, _("IDS_ST_BODY_ABOUT_DEVICE"), NULL, NULL, view_data.main_list, NULL);
